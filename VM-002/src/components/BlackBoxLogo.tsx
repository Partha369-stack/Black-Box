...
const BlackBoxLogo: React.FC<{ size?: number | string }> = ({ size = 48 }) => (
  <svg
    width={size}
    height={(size as number) * 0.854} // maintain aspect ratio
    viewBox="0 0 130 111"
    fill="none"
